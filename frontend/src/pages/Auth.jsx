...
const Auth = ({ onAuthSuccess }) => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      if (isLogin) {
        // Login flow
        await authService.loginRequest(formData.mobile);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/30 to-mint-50/50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
          ...
          {step === 'mobile' ? (
                ...
                <>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="block w-full pl-12 pr-4 py-3 text-lg border-2 border-slate-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-700 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-colors"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      value={formData.role}
                      onChange={handleChange}
                      className="block w-full px-4 py-3 text-lg border-2 border-slate-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-colors"
                    >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-y-0 left-12 flex items-center pointer-events-none">
                    <span className="text-slate-600 dark:text-slate-400 text-lg font-medium">+91</span>
                  </div>
                  <input
                    type="tel"
                    name="mobile"
                    ...
                    onChange={handleChange}
                    maxLength="10"
                    className="block w-full pl-24 pr-4 py-4 text-lg border-2 border-slate-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-700 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-colors"
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-6">
              ...
              <div className="text-center">
                <p className="text-slate-600 dark:text-slate-400 mb-2">OTP sent to</p>
              ...
              {/* OTP Input */}
              <div>
                <label className="block text-base font-semibold text-slate-700 dark:text-slate-300 mb-4 text-center">
                  Enter 6-Digit OTP
                </label>
                <div className="flex gap-2 justify-center">
                  {formData.otp.map((digit, index) => (
                    <input
                      ...
                      className="w-12 h-14 text-center text-2xl font-bold border-2 border-slate-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-colors"
                    />
                  ))}
                </div>
              </div>
              ...
              <div className="text-center">
                {canResend ? (
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-base">
                    Resend OTP in <span className="font-bold text-emerald-600 dark:text-emerald-400">{otpTimer}s</span>
                  </p>
                )}
              </div>
        ...
        {step === 'mobile' && (
          <p className="text-center text-base text-slate-600 dark:text-slate-400 mt-6">
